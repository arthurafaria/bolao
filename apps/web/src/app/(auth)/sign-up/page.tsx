	...
	return (
		<div className="space-y-7">
			...
			<button
				...
				className="flex w-full cursor-pointer items-center justify-center gap-3 rounded-2xl border px-4 py-3 font-medium text-sm transition-colors hover:bg-[var(--b-surface-2)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--b-brand)] disabled:cursor-not-allowed disabled:opacity-60"
				style={{
