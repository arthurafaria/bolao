	...
	return (
		<div>
			...
			<button
				...
				className="mb-6 flex w-full items-center justify-center gap-3 rounded-2xl border px-4 py-3 text-sm font-medium transition-colors hover:bg-[var(--b-surface-2)]"
				style={{
