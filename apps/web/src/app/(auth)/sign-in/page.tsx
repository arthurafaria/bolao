        ...
        {[
          ...
          return (
            <button
              ...
              className="flex h-10 items-center justify-center gap-2 rounded-xl text-sm font-semibold transition-[background-color,color,transform] active:scale-[0.96]"
              style={{
      ...
      {mode === "password" ? (
        ...
        <form
          onSubmit={async (event) => {
            ...
            const parsedEmail = z.string().email("Email inválido").safeParse(magicEmail);
            if (!parsedEmail.success) {
              toast.error(parsedEmail.error.issues[0]?.message ?? "Email inválido");
              return;
            }
        ...
        >
          ...
          <Button
            type="submit"
            className="h-11 w-full font-display text-base font-bold uppercase tracking-wide"
