    ...
    <div className="space-y-8">
      ...
      >
        ...
        <p className="mb-5 text-sm" style={{ color: "var(--b-text-3)" }}>
          Cada jogo tem dois componentes independentes: <strong style={{ color: "var(--b-text)" }}>resultado</strong> e{" "}
          <strong style={{ color: "var(--b-text)" }}>placar individual de cada time</strong>.
        </p>
          ...
          {[
            ...
            >
              ...
              <div>
                ...
                <p className="mt-0.5 text-sm leading-relaxed" style={{ color: "var(--b-text-3)" }}>
                  {desc}
                </p>
              </div>
            </div>
        ...
        <div
          ...
          style={{ background: "var(--b-brand-10)", border: "1px solid var(--b-brand-15)" }}
        >
          <p style={{ color: "var(--b-text-2)" }}>
            <span className="font-semibold" style={{ color: "var(--b-text)" }}>Resultado certo</span> vale{" "}
            <span className="font-bold" style={{ color: "var(--b-brand-hi)" }}>5 pts</span> de base.
          </p>
          <p style={{ color: "var(--b-text-2)" }}>
            <span className="font-semibold" style={{ color: "var(--b-text)" }}>Gols de um time acertados</span> vale{" "}
            <span className="font-bold" style={{ color: "var(--b-brand-hi)" }}>+2 pts</span>{" "}
            — independente do resultado. Conta para o time da casa e para o visitante separadamente.
          </p>
          <p style={{ color: "var(--b-text-2)" }}>
            Os dois bônus se somam: acertou resultado (+5) e gols de um time (+2) = <span className="font-bold" style={{ color: "var(--b-text)" }}>7 pts</span>.
            Acertou os dois placares = <span className="font-bold" style={{ color: "var(--b-text)" }}>10 pts</span>.
          </p>
        </div>
      </section>
      ...
      >
        ...
        <p className="mb-4 text-sm" style={{ color: "var(--b-text-3)" }}>
          Jogo real: <span className="font-semibold" style={{ color: "var(--b-text)" }}>Brasil 2 × 1 Argentina</span>
        </p>
        ...
        <div className="space-y-2">
          {[
            ...
            <div
              ...
              style={{ background: "var(--b-inner)", border: "1px solid var(--b-border-sm)" }}
            >
              <div className="min-w-0 flex-1">
                <p className="text-sm font-semibold" style={{ color: "var(--b-text)" }}>
                  {guess}
                </p>
                <p className="mt-0.5 text-xs" style={{ color: "var(--b-text-3)" }}>
                  {breakdown}
                </p>
              </div>
              <div
      ...
      >
        ...
        <p className="mb-4 text-sm leading-relaxed" style={{ color: "var(--b-text-3)" }}>
          Mesmo errando quem ganhou, você marca{" "}
          <span className="font-semibold" style={{ color: "var(--b-text)" }}>+2 pts</span> por cada time cujo número de gols você acertou.
        </p>

        <div
          className="mb-4 rounded-xl px-4 py-3 text-sm"
          style={{ background: "var(--b-inner)", border: "1px solid var(--b-border)" }}
        >
          <span style={{ color: "var(--b-text-3)" }}>Jogo real: </span>
          <span className="font-bold" style={{ color: "var(--b-text)" }}>Brasil 2 × 1 Argentina</span>
      ...
      >
        ...
        <p className="text-sm leading-relaxed" style={{ color: "var(--b-text-2)" }}>
          Os palpites ficam abertos até{" "}
          <span className="font-semibold" style={{ color: "var(--b-text)" }}>1 hora antes do início</span> de cada jogo.
          Depois disso, o placar é bloqueado e não pode mais ser alterado.
        </p>
        <p className="mt-3 text-sm leading-relaxed" style={{ color: "var(--b-text-2)" }}>
      ...
      >
        ...
        <p className="text-sm leading-relaxed" style={{ color: "var(--b-text-2)" }}>
          ...
          <span className="font-semibold" style={{ color: "var(--b-text)" }}>50 membros</span>.
        </p>
        <p className="mt-3 text-sm leading-relaxed" style={{ color: "var(--b-text-2)" }}>
