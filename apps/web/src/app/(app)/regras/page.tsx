		...
		<div className="space-y-8">
			...
			>
				...
				<div className="space-y-3">
					{SCORING_TIERS.map(({ pts, label, desc }) => {
						...
						return (
							...
							>
								<div
									...
									style={{ color: tier.color, background: "var(--b-tint-md)" }}
								>
									{tier.prefix && (
										<span className="mr-0.5 text-sm">{tier.prefix}</span>
									)}
									{pts}
								</div>
								<div>
			...
			>
				...
				>
					...
					assim que o jogo é bloqueado — os concorrentes só podem ver o que você
					palpitou depois que a janela fecha.
				</p>
			</section>
